            ...
            transaction.stage === "connecting" ? (
              ...
              <>
                ...
                <p className="mx-auto mt-3 max-w-[400px] text-sm leading-6 text-foreground/80">
                  AETHRIONIS Studio lets you bring multiple agents into the same workspace.
                  Your team will help you get started using AETHRIONIS Studio.
                </p>
