...
export const WELCOME_GUIDE_AGENT_NAME = "Draft";
...
export const WELCOME_GUIDE_INTRO_MESSAGE =
  "Hi, I'm Draft. Welcome to AETHRIONIS Studio.\n\nI can help you get oriented, answer questions, and make the first few steps feel less mysterious.\n\nFeel free to ask me what else you can do in AETHRIONIS Studio, or just talk through what you want to build.";
...
export const WELCOME_TEAM_STARTERS = [
  { name: "Draft", personaId: "builtin:fizz", role: "lead" },
  { name: "Read", personaId: "builtin:honey", role: "teammate" },
  { name: "Probe", personaId: "builtin:bumble", role: "teammate" },
