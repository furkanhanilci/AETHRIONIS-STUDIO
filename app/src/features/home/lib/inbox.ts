...
export type InboxItem = {
   ...
   * repository-scoped root for AETHRIONIS Studio Git work. Does NOT change when a new reply
...
/**
 * Returns the stable conversation ID for any FeedItem or relay event. AETHRIONIS Studio Git
