    ...
    richText.editor.setOptions({
      editorProps: {
        ...
        handlePaste: (_view, event) => {
          ...
          // --- AETHRIONIS Studio code-block paste ---
          // The code block copy button writes a small AETHRIONIS Studio marker alongside
          ...
          // Restore AETHRIONIS Studio snapshots before normal styled-HTML normalization.
