/**
 * Detect whether clipboard HTML contains AETHRIONIS Studio mention / channel-link
...
/**
 * Normalize clipboard HTML that contains AETHRIONIS Studio mention / channel-link
