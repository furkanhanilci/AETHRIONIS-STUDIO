...
const COPY_SUCCESS_MESSAGE =
  "Signed response copied. Paste it into the AETHRIONIS Studio admin console.";
const PREVIEW_COPY_SUCCESS_MESSAGE = "Preview response copied.";
const COPY_FAILURE_MESSAGE = "AETHRIONIS Studio couldn't access the clipboard. Try again.";
    ...
    const unlistenPromise = listenForNostrBindDeepLinks((nextPayload) => {
      ...
      getIdentity()
        ...
        .catch((error) => {
          ...
          setIdentity(null);
          setError("Could not load the current AETHRIONIS Studio identity.");
        });
    });
                ...
                >
                  <DialogPrimitive.Title className="mt-6 text-3xl font-semibold tracking-tight">
                    {payload.returnMode === "browser_fragment_v1"
                      ...
                      : "Finish on the AETHRIONIS Studio website"}
                  ...
                  >
                    {payload.returnMode === "browser_fragment_v1"
                      ? "AETHRIONIS Studio opened your browser to finish verification."
                      : "Copy the response below, then paste it into the AETHRIONIS Studio website to finish verification."}
                  </DialogPrimitive.Description>
