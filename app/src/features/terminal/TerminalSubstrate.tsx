...
export function TerminalSubstrate({
   ...
   * ownership: in AETHRIONIS Studio mode these keys belong to the rest of the app.
   */
  ...
  return (
    <section
      aria-label="AETHRIONIS Studio Term"
    ...
    >
      {mode === "docked" ? (
        <hr
          aria-label="Resize AETHRIONIS Studio Term"
      ...
      <div className="buzz-terminal-contract-bar">
        <div className="buzz-terminal-tabs" role="tablist">
          ...
          <button
            aria-label="New AETHRIONIS Studio Term tab"
        ...
        <div className="buzz-terminal-readout">
          <button
            aria-label={
              mode === "maximized" ? "Restore AETHRIONIS Studio Term" : "Maximize AETHRIONIS Studio Term"
            }
          ...
          <button
            aria-label="Hide AETHRIONIS Studio Term"
            className="buzz-terminal-window-action"
            onClick={onHide}
            type="button"
          >
      ...
      <div aria-live="polite" className="sr-only">
        {owner === "terminal" ? "AETHRIONIS Studio Term mode" : "AETHRIONIS Studio mode"}
      </div>
    </section>
  );
}
