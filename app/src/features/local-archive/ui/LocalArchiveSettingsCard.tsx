  ...
  return (
    <section className="min-w-0" data-testid="settings-local-archive">
      <SettingsSectionHeader
        title="Local archive"
        description="Save copies of relay messages to a local SQLite database in your AETHRIONIS Studio nest. Events are re-verified against the relay at archive time."
      />
