...
import { GithubSettingsCard } from "@/features/aethrionis/ui/GithubSettingsCard";
import { IdentityBackupCard } from "@/features/aethrionis/ui/IdentityBackupCard";
...
export const settingsSections: SettingsSectionDescriptor[] = [
  ...
  {
    value: "github-membership",
    label: "GitHub membership",
    icon: Users,
  },
  {
...
// it) and exits upward (slides up behind the grid when AETHRIONIS Studio hides it). No
...
function ThemeSettingsCard() {
  ...
  // AETHRIONIS Studio themes pin a neutral accent (GitHub black in light, white in dark),
  // so the accent picker is hidden while a AETHRIONIS Studio theme is active. `themeName` is
  // the effective theme, so this also covers System mode resolving to AETHRIONIS Studio.
    ...
    >
      ...
      <div className="relative">
        ...
        {/* Bottom fade — hidden while the accent picker is visible so its
            near-white gradient (AETHRIONIS Studio light) can't mask the swatches below it
  ...
  return (
    ...
    >
      <SettingsSectionHeader
        title="Appearance"
        description="Choose how AETHRIONIS Studio looks and feels."
      />
      ...
      <SettingsOptionGroupList>
        ...
        >
          ...
          <SettingsOptionRow data-testid="theme-style-row">
            <div className="min-w-0">
              ...
              <p
                ...
                data-settings-subcopy
              >
                Choose the colors used throughout AETHRIONIS Studio.
              </p>
            </div>
            <button
          ...
          {/* Accent color picker — hidden for AETHRIONIS Studio themes (pinned neutral accent).
...
export function renderSettingsSection(
  ...
  switch (section) {
    ...
    case "github-membership":
      return <GithubSettingsCard />;
    case "identity-backup":
      return <IdentityBackupCard />;
