    ...
    >
      <li className="flex min-w-0 items-start gap-4">
        ...
        <div className="min-w-0 pt-0.5">
          ...
          >
            Open AETHRIONIS Studio on your mobile device and scan the code shown here.
          </p>
        </div>
      </li>
  ...
  return (
    <section className="min-w-0" data-testid="settings-mobile">
      <SettingsSectionHeader
        ...
        description={
          <>
            Connect the AETHRIONIS Studio mobile app to this relay by scanning a QR code. The
