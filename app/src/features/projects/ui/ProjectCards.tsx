...
function RepositoryUnavailableIndicator({
  ...
  const status = {
    authentication: {
      description: "AETHRIONIS Studio could not authenticate with this repository.",
      label: "Access failed",
    },
    missing: {
      description: "No git repository was found on the AETHRIONIS Studio relay.",
      label: "Uninitialized",
    },
    access: {
      description:
    ...
    network: {
      description: "The AETHRIONIS Studio git service could not be reached.",
      label: "Unreachable",
    },
    ref: {
    ...
    unknown: {
      description: "AETHRIONIS Studio could not load this repository.",
      label: "Unavailable",
    },
  } satisfies Record<
