...
> = {
  authentication: {
    description:
      "AETHRIONIS Studio could not authenticate with this repository. Check your access and try again.",
    title: "Repository access failed",
  },
  missing: {
    description:
      "The project announcement exists, but its git repository was not found on the AETHRIONIS Studio relay.",
  ...
  network: {
    description:
      "The AETHRIONIS Studio git service could not be reached. Check your connection and try again.",
  ...
  unknown: {
    description:
      "AETHRIONIS Studio could not load this repository. Try again or contact the project owner.",
