...
// "create" is gone with the hosted service it opened. A workspace here is a
// relay someone runs, and this dialog connects to one.
...
export function AddCommunityDialog({
  ...
  const title =
    mode === "join" ? "Connect to a workspace" : "Add workspace";

  const description =
    mode === "join"
      ? "Use the workspace URL or invite link you received."
      : "Connect to a workspace someone runs.";
