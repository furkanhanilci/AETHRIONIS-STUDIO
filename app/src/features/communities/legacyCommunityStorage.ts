...
/**
 * Seed AETHRIONIS Studio localStorage from legacy Sprout WebKit localStorage before the app
 ...
 * AETHRIONIS Studio does not already have community state, except for the known broken
 * Sprout→AETHRIONIS Studio first-run handoff that created a single localhost community.
 */
