...
import { Route as dumeRouteImport } from "./routes/dume";
...
const dumeRoute = dumeRouteImport.update({
  id: "/dume",
  path: "/dume",
  getParentRoute: () => rootRouteImport,
} as any);
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/dume": {
      ...
      path: "/dume";
      fullPath: "/dume";
      preLoaderRoute: typeof dumeRouteImport;
      parentRoute: typeof rootRouteImport;
    };
    "/projects": {
      id: "/projects";
