...
// AETHRIONIS Studio relay hosts differ per community, so relay git URLs are recognized by
...
/**
 * Recognize a AETHRIONIS Studio relay git URL (`{relay-origin}/git/<owner-pubkey>/<repo>`,
 ...
 * active AETHRIONIS Studio relay — an arbitrary external URL sharing the path shape must
