 ...
 *
 * Only URLs hosted on the AETHRIONIS Studio relay are rewritten. External Blossom URLs
 ...
 * (the AETHRIONIS Studio relay), resulting in 404s.
 */
...
/**
 * If `url` is a Blossom media URL hosted on the AETHRIONIS Studio relay, rewrite it
