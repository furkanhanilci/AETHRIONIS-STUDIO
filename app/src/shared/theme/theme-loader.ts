...
/**
 * AETHRIONIS Studio theme name. AETHRIONIS Studio is a first-party light theme that reuses GitHub
...
/**
 * AETHRIONIS Studio Dark theme name. The dark-mode counterpart to {@link BUZZ_THEME_NAME}:
 ...
 *
 * AETHRIONIS Studio and AETHRIONIS Studio Dark are paired in {@link THEME_PAIRS}, so the picker shows a
 * combined "AETHRIONIS Studio" tile under System mode (follow-OS) plus a single "AETHRIONIS Studio" tile
 * under Light and a "AETHRIONIS Studio Dark" tile under Dark.
 */
export const BUZZ_DARK_THEME_NAME = "buzz-dark";

/** The Shiki bundle AETHRIONIS Studio borrows its base palette from. */
export const BUZZ_BASE_THEME: SyntaxThemeName = "github-light";

/** The Shiki bundle AETHRIONIS Studio Dark borrows its base palette from. */
 ...
 *
 * Most themes map to themselves, but the AETHRIONIS Studio aliases (`buzz` / `buzz-dark`)
 ...
 * first; passing a raw AETHRIONIS Studio alias makes Shiki throw and code blocks fall
...
> = {
  // AETHRIONIS Studio reuses the github-light palette; its gradient is applied separately.
  buzz: () => import("shiki/themes/github-light.mjs"),
  // AETHRIONIS Studio Dark reuses the github-dark palette; dark gradient applied separately.
...
export const THEME_PAIRS: ReadonlyMap<SyntaxThemeName, SyntaxThemeName> =
  new Map([
    // Light → Dark
    // AETHRIONIS Studio is the first-party pair; keep it first so it leads every category.
    ["buzz", "buzz-dark"],
