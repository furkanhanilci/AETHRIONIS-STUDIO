...
function RequirementRow({
  ...
  switch (requirement.surface) {
    ...
    case "cli_config_invalid": {
      ...
      // external file. No Agent runtimes CTA (AETHRIONIS Studio can't repair ~/.codex/config.toml)
      // and no Edit Agent CTA (the field isn't managed by AETHRIONIS Studio).
