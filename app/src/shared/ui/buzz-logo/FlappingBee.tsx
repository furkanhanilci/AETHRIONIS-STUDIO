...
/**
 * The AETHRIONIS Studio bee mark with flapping wings. Geometry is identical to the static
 ...
 * from the AETHRIONIS Studio website) beating the wings on an infinite loop.
 *
